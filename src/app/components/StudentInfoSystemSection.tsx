...
export function StudentInfoSystemSection() {
  return (
    <section id="student-information-system" className="py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <Card className="p-8 lg:p-12 border border-border bg-card/50 dark:bg-slate-950/80 shadow-sm hover:shadow-xl dark:shadow-none backdrop-blur-xl transition-all duration-300">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <Button className="bg-[#e35336] dark:bg-[#f47236] text-white hover:bg-[#c4452b] dark:hover:bg-[#e35336] border border-[#e35336]/70 dark:border-[#f47236]/70 shadow-lg shadow-orange-500/20">
                  Request a Demo
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </div>
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 rounded-2xl p-8 flex items-center justify-center min-h-[300px] border border-border shadow-inner">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-card dark:bg-slate-950 rounded-xl p-4 shadow-sm border border-border">
                    <Users className="h-8 w-8 text-primary mx-auto mb-2" />
                    <span className="text-sm font-medium text-foreground">Student Records</span>
                  </div>
                  <div className="bg-card dark:bg-slate-950 rounded-xl p-4 shadow-sm border border-border">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 border border-border bg-card/50 dark:bg-slate-950/80 hover:border-primary/50 dark:hover:border-sky-400/60 transition-all duration-300 rounded-2xl backdrop-blur-xl shadow-sm hover:shadow-xl dark:shadow-none group"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-sky-400 via-cyan-300 to-fuchsia-400 rounded-xl flex items-center justify-center flex-shrink-0 shadow-[0_16px_40px_rgba(56,189,248,0.3)] dark:shadow-[0_16px_40px_rgba(56,189,248,0.7)] group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sisFeatures.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 border border-border bg-card/50 dark:bg-slate-950/80 hover:border-primary/50 dark:hover:border-sky-400/60 transition-all duration-300 group rounded-2xl backdrop-blur-xl shadow-sm hover:shadow-xl dark:shadow-none"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-sky-400 via-cyan-300 to-fuchsia-400 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-[0_16px_40px_rgba(56,189,248,0.3)] dark:shadow-[0_16px_40px_rgba(56,189,248,0.7)]">
                    <Icon className="h-6 w-6 text-white dark:text-slate-950" />
                  </div>
                  <h4 className="text-lg font-semibold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">
                    {feature.title}
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <Card className="p-8 border border-primary/20 dark:border-cyan-300/40 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 transition-all duration-300 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  ...
                  <span className="text-foreground/80 dark:text-slate-200">{item}</span>
                </div>
              ))}
            </div>
          </Card>
