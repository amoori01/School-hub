      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={headerRef} className="text-center max-w-4xl mx-auto mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            <span className="block text-slate-50">A complete suite of</span>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-5">
                  <div className="w-12 h-12 bg-gradient-to-br from-sky-400 via-cyan-300 to-fuchsia-400 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:-rotate-2 transition-all duration-500 shadow-[0_16px_40px_rgba(56,189,248,0.7)]">
                    <Icon className="h-6 w-6 text-slate-950" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-slate-50 mb-3 group-hover:text-sky-200 transition-colors duration-300">
                      {module.title}
                    </h3>
                    ...
                    <ul className="space-y-2">
                      {module.features.map((feature, fIndex) => (
                        <li
                          key={fIndex}
                          className="text-xs text-slate-400 flex items-center gap-2 group-hover:text-slate-200 transition-colors duration-300"
                        >
                          <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-sky-400 to-fuchsia-400" />
                          {feature}
                        </li>
                      ))}
                    </ul>
